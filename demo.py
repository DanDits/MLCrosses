...
def demo_crosses_simple(training_data, test_data, eta, cost, neuron):
    ...
    # Working configs of 6859 tests:
    # demo.demo_crosses_simple(training, test, 0.1, quad, linear) # peak 6842; rate=1: peak 6842; and any higher learning rate (but gets more fluctuating)!
    # demo.demo_crosses_simple(training, test, 0.0001, quad, linear) # to watch actual (slow) learning
