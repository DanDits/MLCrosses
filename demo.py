...
def demo_crosses_simple(training_data, test_data, eta, cost, neuron):
    ...
    # demo.demo_crosses_simple(training, test, 0.0003, quad, linear) # peak 6785; rate=0.0005 peak 6815 (about 50 epochs, SLOW!); not learning with rate >= 0.001!
...
def run_simple():
    ...
    import network_simple as network
    demo_crosses_simple(training, test, 0.0005, network.QuadraticCost, network.LinearNeuron)
